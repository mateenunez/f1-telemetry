          ...
          {raceControlLog && (
            <div className="space-y-2">
              {raceControl && raceControl?.length > 0 ? (
                raceControl.map((msg, idx) => (
                  ...
                  >
                    <div className="flex flex-row gap-2 rounded">
                      <div className="relative w-full max-w-full my-2 text-gray-400 border-none items-start border-[2px] rounded border-gray-400 flex flex-col px-2 py-1 font-f1-regular">
                ...
                <div className="min-h-[20rem] justify-center items-center flex font-f1-regular">
